...
<body>
    <div class="container-fluid">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body">
              <h1 class="text-center mb-4">Tambah Data Pemusnahan</h1>
              <div class="container">
                              ...
                              <div class="card-body">
                                  <form method="POST" action="{{ route('pemusnahan.store') }}" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group" style="border-radius: 8px;">
                                        ...
                                        <select class="form-select" name="id_bukurusak" id="judulbuku" style="border-radius: 8px;" data-placeholder="PILIH JUDUL BUKU">
                                            <option></option>
                                            @foreach ($masterbukurusak as $item)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kondisi" class="form-control @error('kondisi') is-invalid @enderror" id="kondisi" required>
                                            ...
                                            <option value="Hilang" {{ old('kondisi') == 'Hilang' ? 'selected' : '' }}>Halaman Hilang</option>
                                            <option value="CoverRusak" {{ old('kondisi') == 'CoverRusak' ? 'selected' : '' }}>Cover Rusak</option>
                                            <option value="Kotor" {{ old('kondisi') == 'Kotor' ? 'selected' : '' }}>Buku Kotor</option>
                                            <option value="Usang" {{ old('kondisi') == 'Usang' ? 'selected' : '' }}>Buku Usang</option>
                                            <option value="Bergeming" {{ old('kondisi') == 'Bergeming' ? 'selected' : '' }}>Buku Bergeming</option>
                                            <option value="Ditemukan" {{ old('kondisi') == 'Ditemukan' ? 'selected' : '' }}>Buku Ditemukan di Tempat yang Tidak Semestinya</option>
                                        </select>
                                        @error('kondisi')
