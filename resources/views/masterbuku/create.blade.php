                              ...
                              <div class="card-body">
                                  <form method="POST" action="{{ route('masterbuku.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sipnosis" class="form-control @error('sipnosis') is-invalid @enderror" id="sipnosis" placeholder="Masukkan Sipnosis" value="{{ old('sipnosis') }}" required>
                                        @error('sipnosis')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
